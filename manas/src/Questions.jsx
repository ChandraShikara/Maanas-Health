...
//   const [lastStressTestDate, setLastStressTestDate] = useState(localStorage.getItem('lastStressTestDate') || null);
// const [lastDepressionTestDate, setLastDepressionTestDate] = useState(localStorage.getItem('lastDepressionTestDate') || null);
// const [lastAnxietyTestDate, setLastAnxietyTestDate] = useState(localStorage.getItem('lastAnxietyTestDate') || null);
...
//     if (lastStressTestDate && isSameDay(new Date(), new Date(lastStressTestDate))) {
//       setstressvis(false)
//       toast.warning("You can only take the stress test once a day.", { position: toast.POSITION.TOP_CENTER });
//     }
//     else{
...
//       localStorage.setItem('lastStressTestDate', currentDate);
//     }
//     }
//   }
...
//     if (lastDepressionTestDate && isSameDay(new Date(), new Date(lastDepressionTestDate))) {
//     setdepressionvis(false)
//       toast.warning("You can only take the depression test once a day.", { position: toast.POSITION.TOP_CENTER });
//     }
// else{
...
//     localStorage.setItem('lastDepressionTestDate', currentDate);
//   }
// }
//   }
...
//     if (lastAnxietyTestDate && isSameDay(new Date(), new Date(lastAnxietyTestDate))) {
//       setanxeityvis(false)
//       toast.warning("You can only take the anxiety test once a day.", { position: toast.POSITION.TOP_CENTER });
//     }
...
//       localStorage.setItem('lastAnxietyTestDate', currentDate);
//     }
...
//         <div className="sda">
//           <button onClick={() => { openDiv('stress') }} className="pred">Stress Prediction</button>
//           <button onClick={() => { openDiv('depression') }} className="pred">Depression Prediction</button>
//           <button onClick={() => { openDiv('anxeity') }} className="pred">Anxiety Prediction</button>
//         </div>
//         <div>
...
//           {submit && submitvis && <Link to={`/report`}><span className="viewreport">View Report</span></Link>}
//           {submit1 && submitvis1 && <Link to={`/report`}><span className="viewreport">View Report</span></Link>}
//           {submit2 && submitvis2 && <Link to={`/report`}><span className="viewreport">View Report</span></Link>}
...
//--------------------------------------Stress--------------------------------------------------
  ...
  const openDiv = (divName) => {
    ...
    if (divName === 'stress') {
      if (lastStressTestDate && isSameDay(new Date(), new Date(lastStressTestDate))) {
        setstressvis(false)
        return toast.warning("You can only take the stress test once a day.", { position: toast.POSITION.TOP_CENTER });
      }
      setstressvis(true)
      setdepressionvis(false)
      setanxeityvis(false)
    ...
    if (divName === 'depression') {
      if (lastDepressionTestDate && isSameDay(new Date(), new Date(lastDepressionTestDate))) {
        setdepressionvis(false)
         return toast.warning("You can only take the depression test once a day.", { position: toast.POSITION.TOP_CENTER });
        }
      setdepressionvis(true)
      setstressvis(false)
      setanxeityvis(false)
    ...
    if (divName === 'anxeity') {
      if (lastAnxietyTestDate && isSameDay(new Date(), new Date(lastAnxietyTestDate))) {
        setanxeityvis(false)
       return toast.warning("You can only take the anxiety test once a day.", { position: toast.POSITION.TOP_CENTER });
      }
      setanxeityvis(true)
      setdepressionvis(false)
      setstressvis(false)
