...
//       toast.warning('Please fill the details!', { position: toast.POSITION.TOP_CENTER })
//       isValid = false
//     } else {
//       // Password validation
...
//           res => {
//             if (res.data === "Exist") {
//               return toast.error("User already exists", { position: toast.POSITION.TOP_CENTER })
//             }
//             if (res.data === "E-Exist") {
//               return toast.error("Email already exists")
//             }
//             if (res.data === "M-Exist") {
//               return toast.error("Mobile already exists", { position: toast.POSITION.TOP_CENTER })
//             }
//             if (res.data === "Done") {
//               toast.success("Regstartion Succesfull!\nYou can now login", { position: toast.POSITION.TOP_CENTER })
//             }
//           }
...
//       <div className={`mail ${otpvis?'':'otpvis'}`}>
//         <p className="mail-ver">Email Verification</p>
//         <span>An otp is sent your eamil</span>
//         <div className="otp">
//           <input className="inp" placeholder="Enter OTP" />
//           <button className="sub">submit</button>
//         </div>
//         <span>Email Verified Succesfully!</span>
//         <button className="sub1">Resend</button>
//       </div>
//     </div>
//   )
// }
