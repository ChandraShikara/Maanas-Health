    ...
    <div className='reportuniversal'>
      ...
      <div className="report">
        ...
        {latestResult.b.result === 'Moderate' && <div className='Show1'>
          ...
          <p className='p3'>As Your Condition of {latestResult.a} is MODERATE we suggest You few {<Link to='/doctors'><strong className='strongd'> Doctors </strong></Link>}for your mental health checkup</p>
        ...
        {latestResult.b.result === 'Severe' && <div className='Show1'>
          ...
          <p className='p3'>As Your Condition of {latestResult.a} is SEVERE we strongly suggest You few {<Link to='/doctors'><strong className='strongd'> Doctors </strong></Link>}for your mental health checkup</p>
        ...
        {latestResult.b.result === 'Extremely Severe' && <div className='Show1'>
          ...
          <p className='p3'>As Your Condition of {latestResult.a} is EXTREMELY SEVERE we strongly suggest You few {<Link to='/doctors'><strong className='strongd'> Doctors </strong></Link>}for your mental health checkup</p>
